#include "bender_speech/synthesizer.h"
...
synthesizer::synthesizer(): nh_("~") {
	...
	psw.getParameter("language", desired_language, "english");   // english
	...
	// - - - - - - S e r v i c e s - - - - - - - -
	_synthesize_server = nh_.advertiseService("synthesize",&synthesizer::synthesize_server,this);
