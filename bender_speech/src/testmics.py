...
def tester_client(number,mic_name):
    ...
    client = actionlib.SimpleActionClient('/bender/speech/recognizer/recognizer_action', bender_speech.msg.DoRecognitionAction)
    ...
    goal = bender_speech.msg.DoRecognitionGoal(dictionary="Stage1/gpsr_ii",file='/home/robotica/test_speech/'+mic_name+'/test'+str(number))
